 ...
 */
class mrBoxieAdminGeneratorConfiguration extends sfThemeGeneratorConfiguration
{
  protected
  ...
  protected function compile($configs)
  {
    ...
    // create "mrBoxieAdminField" object from supplied options for all configurations of type "field"
  ...
  protected function createFieldFromOptions($name, $options)
  {
    ...
    return new mrBoxieAdminField($name, $options);
  }
